...
t_buffer_ins* serializar_registro_direccion_tamanio(instruccion_params* param){
    ...
    memcpy(buffer->stream + offset, &(param->params.io_stdin_stdout.registro_tamaño), sizeof(uint32_t));
...
{
    size_t archivo_len = strlen(param->params.io_fs_create_params.nombre_archivo) + 1;
    t_buffer_ins* buffer = malloc(sizeof(t_buffer_ins));
    ...
    offset += sizeof(uint32_t);
    memcpy(buffer->stream + offset, param->params.io_fs_truncate_params.nombre_archivo, archivo_len);
    return buffer;
}
...
t_buffer_ins* serializar_io_fs_truncate(instruccion_params* param){
    ...
    memcpy(buffer->stream + offset, param->params.io_fs_truncate_params.nombre_archivo, archivo_len);
    offset += archivo_len;
    memcpy(buffer->stream + offset, &(param->params.io_fs_truncate_params.tamaño), sizeof(uint32_t));
    return buffer;
}

t_buffer_ins* serializar_io_fs_write_read(instruccion_params* param){

    size_t archivo_len = strlen(param->interfaz) + 1;
    size_t size = sizeof(uint32_t) + archivo_len + sizeof(uint32_t) + sizeof(t_dir_fisica) + sizeof(off_t);
    ...
    memcpy(buffer->stream + offset, &archivo_len, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(buffer->stream + offset, param->params.io_fs_read_write.nombre_archivo, archivo_len);
    offset += archivo_len;
    memcpy(buffer->stream + offset, &(param->params.io_fs_read_write.registro_direccion), sizeof(t_dir_fisica));
    offset += sizeof(t_dir_fisica);
    memcpy(buffer->stream + offset, &(param->params.io_fs_read_write.registro_tamaño), sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(buffer->stream + offset, &(param->params.io_fs_read_write.registro_puntero_archivo), sizeof(off_t));
...
{
    size_t archivo_len = strlen(param->params.io_fs_create_delete_params.nombre_archivo) + 1;
    size_t interfaz_len = strlen(param->interfaz) + 1;
    ...
    memcpy(buffer->stream + offset, &archivo_len, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(buffer->stream + offset, param->params.io_fs_create_delete_params.nombre_archivo, archivo_len);
...
{
    size_t archivo_len = strlen(param->params.io_fs_truncate_params.nombre_archivo) + 1;
    size_t interfaz_len = strlen(param->interfaz) + 1;
...
{
    size_t archivo_len = strlen(param->params.io_fs_read_write.nombre_archivo) + 1;
    size_t interfaz_len = strlen(param->interfaz) + 1;
